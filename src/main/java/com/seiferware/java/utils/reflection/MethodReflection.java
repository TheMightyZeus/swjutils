...
public final class MethodReflection {
	...
	/**
	 * <p>
	 * Provides a human-readable method signature. If two methods with the same
	 * signature exist on different classes in a class hierarchy, one will
	 * override the other.
	 * </p
	 * <p>
	 * For example: {@code getSignature(Method)}
	 * </p>
	 * 
	 * @param m
	 *            The method.
