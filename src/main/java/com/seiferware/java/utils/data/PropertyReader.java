...
/**
 * Provides a wrapper around a {@link Properties} object that provides
 * convenience methods for interpreting various types of data.
 */
public class PropertyReader {
	 ...
	 */
	public PropertyReader(final Properties properties) {
		props = properties;
	}
	 ...
	 * @param defaultValue
	 *            The default value to use if {@code key} does not exist as a
	 ...
	 * @param defaultValue
	 *            The default value to use if {@code key} does not exist as a
	 *            key in the properties object, or the value cannot be parsed as
	 *            a boolean.
	 * @return The value associated with {@code key}, or {@code defaultValue} if
	 *         {@code key} is not present or the value is not valid.
	 */
