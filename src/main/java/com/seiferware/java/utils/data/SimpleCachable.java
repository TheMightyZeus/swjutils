...
/**
 * An abstract class that assumes some common operations of {@link Cachable},
 * leaving only the retrieval of the data by key unimplemented for child
 * classes. If asynchronous retrieval of values is required, use
 * {@link SimpleAsyncCachable}.
 *
 * @param <K>
...
public abstract class SimpleCachable<K, V> implements Cachable<K, V> {
	 ...
	 */
	protected SimpleCachable(Class<K> keyClass, Class<V> valueClass) {
